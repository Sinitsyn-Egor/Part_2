...
# https://github.com/reddyprasade/DataSet-for-ML-and-Data-Science/blob/f77724b8a089762ebdccb177cfa071497f3a1185/DataSets/california_cities.csv
# cities = pd.read_csv('data_files/california_cities.csv')
#
# latd = cities['latd']
# longd = cities['longd']
...
#
# plt.legend(frameon = True,labelspacing=2, title = 'Площадь')
#
# plt.axis('equal')
...
from sklearn.manifold import Isomap  # noqa: E402

iso = Isomap(n_components=2, n_neighbors=10)
prj = iso.fit_transform(digits.data)

plt.scatter(prj[:, 0], prj[:, 1], c=digits.target, cmap=plt.get_cmap("jet", 12))
