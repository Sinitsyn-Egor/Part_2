...
print(x)
# how = all - убрать, если все значени отстствуют
# how = any - убрать, если хотя бы 1 отсутствует


print(x.dropna(axis=0, how="all"))
print(x.dropna(axis=0, thresh=0))  # должно быть минимум непустых значения
...
print(s.iloc[[0, 2, 4]])
print(s.loc[[i for i in s.index if i[1] == 2025]])
...
# одомерный Series может хранить данные с большим числом измерений
index = [
    ("A1", 2025, 1),
    ("A1", 2026, 1),
    ("A1", 2025, 2),
