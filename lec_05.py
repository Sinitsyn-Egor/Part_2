...
print(pd.DataFrame(np.zeros(4)))

# Index - способ сослатся (reference) на данные Series или DataFrame
...
print(data[(data > 0.6) & (data < 0.8)])

print(data.loc[["c", "a"]])  # название ключей
print(data.iloc[[2, 0]])  # название индексов
